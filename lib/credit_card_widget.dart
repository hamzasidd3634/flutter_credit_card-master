    ...
    if (widget.obscureCardNumber) {
      ...
      if (stripped.length > 8) {
        final String middle = number
            .substring(stripped.length == 9 ? 4 : 7, number.length - 5)
            .trim()
            .replaceAll(RegExp(r'\d'), '*');
        number = stripped.substring(0, 0) +
            ' ' +
            middle +
            ' ' +
    ...
    return CardBackground(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            padding:
                const EdgeInsets.only(left: 16, right: 16, bottom: 5, top: 16),
            child: Visibility(
              ...
              child: Row(
                children: [
                  ...
                  Spacer(),
                  widget.bankNameWidget ?? SizedBox.shrink()
                ],
              ),
            ),
          ),
